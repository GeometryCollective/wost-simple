...
\inputminted[firstline=65,lastline=75,bgcolor=bg]{cpp}{../code/WoStLaplace2D.cpp}
...
\inputminted[firstline=77,lastline=88,bgcolor=bg]{cpp}{../code/WoStLaplace2D.cpp}
...
\inputminted[firstline=48,lastline=60,bgcolor=bg]{cpp}{../code/WoStLaplace2D.cpp}
...
\inputminted[firstline=90,lastline=109,bgcolor=bg]{cpp}{../code/WoStLaplace2D.cpp}
